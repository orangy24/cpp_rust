...
| Talk | Why |
| --- | --- |
| Kate Gregory, [10 Core Guidelines You Need to Start Using Now](https://www.youtube.com/watch?v=XkDEzfpdcSg) (CppCon 2017) | `const`, ownership in signatures |
| Klaus Iglberger, [Back to Basics: C++ Value Semantics](https://www.youtube.com/watch?v=G9MxNwUoSt0) (CppCon 2022) | Values vs identities |
| Klaus Iglberger, [Move Semantics part 1](https://www.youtube.com/watch?v=St0MNEU5b0o) then [part 2](https://www.youtube.com/watch?v=pIzaZbKUw2s) (CppCon 2019) | When `T&&` is a contract |
